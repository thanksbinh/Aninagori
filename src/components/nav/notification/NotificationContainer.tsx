...
const NotificationContainer: React.FC<Props> = ({ myUserInfo, setUnreadNoti, showNotification }) => {
  ...
  return (
    <div className="absolute right-0 h-[23rem] w-80 top-12 z-40 bg-white rounded-md shadow-lg">
      ...
      <div className="h-full bg-white rounded-md pb-2">
        <div className="h-full overflow-y-auto bg-white rounded-md">
