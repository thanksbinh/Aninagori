    ...
    <div className="flex flex-col items-center justify-center h-screen">
      <form onSubmit={handleSubmit} className="w-full max-w-md">
        ...
        <div className="flex">
          {
            loading ? (
              <button disabled type="button" className="bg-blue-500 hover:bg-blue-700 text-gray-400 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
      ...
      <button
        ...
        className="bg-red-500 hover:bg-red-700 text-gray-400 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-4"
      >
        Login with Google
      </button>
